...
with open("input.txt", "r", encoding='utf-8-sig') as input_file: # Note: spefiying the encoding paramter allows for exclusion of the byte order mark "ufeff"
